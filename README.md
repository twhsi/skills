...
| 2 | FIRE 分析 | Full-D / Index / Route / Evolution | [`fire-analysis-card`](skills/fire-analysis-card/) |
...
- [`skills/fire-analysis-card/`](skills/fire-analysis-card/)：用 FIRE 2.0 把筆記整理成語意搜尋前置結構。
...
| [`fire-analysis-card`](skills/fire-analysis-card/) | 以 FIRE 2.0 建立 Full-D、Index、Route、Evolution 搜尋結構 |
