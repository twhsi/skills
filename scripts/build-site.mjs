...
const axisRules = [
  ...
  },
  {
    ...
    label: "Desktop",
    route: "/desktop",
    summary: "Desktop bridges, calendar actions, clipboard outputs and local workflows.",
...
function createAgentManifest(skills) {
  return {
    ...
    tagline: "80% machine-readable, 20% human-readable",
...
- /agent.json: canonical LLM/agent manifest.
...
LLM agents should handle collection, parsing, indexing, conversion, validation and deployment preparation. Humans should review taste, priority, publishing, deletion, overwrites and ambiguous judgment calls.
`;
}
